...
| [регламент/](регламент/) | PDF регламента, схемы полигона, инструкция по запуску робота |
| [gorod_rtk_sim/](gorod_rtk_sim/) | исходники симулятора организаторов — источник точной геометрии |
| [arduino/](arduino/) | прошивка контроллера: мотор-регулятор, обмен с ROS, параметры робота |
